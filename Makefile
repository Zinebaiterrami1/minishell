...
SRC = built-ins/builtin_echo.c minishell.c built-ins/builtin_pwd.c built-ins/builtin_env.c built-ins/builtin_cd.c built-ins/builtin_exit.c parsing/lexer/lexer.c parsing/parser/parser.c parsing/garbage_collector/gc_utils.c parsing/garbage_collector/gc.c\
